=== Plugin Name ===
Contributors: olegf13
Donate link: https://www.free-lance.ru/users/olegf13
...
Before installation you need to register at [pay2pay.com](http://www.pay2pay.com">pay2pay.com) ("Register" section).
...
Testing of the plugin is done using Wordpress 3.5.1 and WooCommerce 2.0.3.
...
Тестирование работы плагина происходило с использованием Wordpress 3.5.1 и WooCommerce 2.0.3.